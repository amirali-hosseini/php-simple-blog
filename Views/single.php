    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
            ...
            <div class="after-post-tags">
                <ul class="tags">
                    <li>
                        <a href="/index.php?category_id=<?= $article_category['id'] ?>"><?= $article_category['title'] ?></a>
                    </li>
                </ul>
            </div>
            <!-- End Tags -->
            ...
            <div class="row post-top-meta"
                ...
                <div class="col-md-10">
                    <a class="link-dark" href="#"><?= $article_author['name'] ?></a>
                    ...
                    <span class="post-date"><?= date('j M Y', strtotime($article['created_at'])) ?></span><span
        ...
        <div class="row listrecent listrelated">
            ...
            <?php if (!empty($related_articles)): ?>
                <?php foreach ($related_articles as $related_article): ?>
                    ...
                    $article_author = $db->query("SELECT `name` FROM `users` WHERE `id` = " . $related_article['user_id']);
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <img class="img-fluid img-thumb" src="/Uploads/articles/<?= $article['image'] ?>" alt="">
                            <div class="card-block">
                                <h2 class="card-title"><a
                                            href="/single.php?article_id=<?= $related_article['id'] ?>"><?= $related_article['title'] ?></a>
                                </h2>
								...
								<span class="post-name"><a href="#"><?= $article_author['name'] ?></a></span><br/>
								<span class="post-date"><?= date('j M Y', strtotime($article['created_at'])) ?></span><span
                                                    class="dot"></span><span
